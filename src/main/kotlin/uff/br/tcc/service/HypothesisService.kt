...
class HypothesisService {
    ...
    fun applyHypothesis(homomorphismValidatorRequest: HomomorphismValidatorRequest): Boolean {
        logger.debug(
        ...
        return homomorphismValidatorRequest.leftDiagram.nodes.firstOrNull {
